...
The second set of graphs confirms this point. We can note in the plot (A) that the average of the testing's positive rate has been systematically decreasing, although the mean percentage of executed testings (B) has increased (which explains the recent growth trend of absolute new cases). And by (C) we notice that the average mortality rate (around 1%) is the lowest observed since the beginning of the pandemic crises.  
<br> 
...
* The total number of cases among the regions are following similar patterns of acceleration since the end of August. However, the Lisbon region shows a bit higher acceleration than the other areas.
* The of total deaths seems to be flattened (like in the overall country view), but again the Lisbon region calls our attention, displaying a distinct trend of deaths acceleration, that should be investigated with attention.
...
The choropleth map below displays the distribution of the total cases over the Portugal macro regions, depicting and highlighting the divergent and more worriest scenario of Lisbon, that is the region displayed in *yellow* with the higher scale of total Covid-19 cases.
...
```{r choropleth-map, fig.cap="Figure 4: Map of Portugal with the geographical distribution of total Covid-19 cases by districts since March 2020"}
